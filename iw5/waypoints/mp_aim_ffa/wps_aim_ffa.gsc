...
mp_aim_ffa()
{
    ...
    waypoints[ 2 ].children[ 2 ] = 68;
    waypoints[ 2 ].children[ 3 ] = 69;
    ...
    waypoints[ 13 ].children[ 2 ] = 72;
    waypoints[ 13 ].children[ 3 ] = 44;
    waypoints[ 13 ].children[ 4 ] = 70;
    ...
    waypoints[ 15 ].children[ 2 ] = 61;
    waypoints[ 15 ].children[ 3 ] = 72;
    waypoints[ 15 ].children[ 4 ] = 80;
    waypoints[ 15 ].children[ 5 ] = 39;
    waypoints[ 15 ].children[ 6 ] = 71;
    ...
    waypoints[ 25 ].children[ 2 ] = 57;
    waypoints[ 25 ].children[ 3 ] = 58;
    ...
    waypoints[ 66 ].children[ 4 ] = 85;
    waypoints[ 67 ] = spawnstruct();
    waypoints[ 67 ].origin = (343.115, 1003.31, 16.125);
    waypoints[ 67 ].type = "stand";
    waypoints[ 67 ].children[ 0 ] = 66;
    waypoints[ 67 ].children[ 1 ] = 6;
    waypoints[ 68 ] = spawnstruct();
    waypoints[ 68 ].origin = (143.031, 518.757, 16.125);
    waypoints[ 68 ].type = "stand";
    waypoints[ 68 ].children[ 0 ] = 4;
    waypoints[ 68 ].children[ 1 ] = 3;
    waypoints[ 68 ].children[ 2 ] = 2;
    waypoints[ 68 ].children[ 3 ] = 69;
    waypoints[ 68 ].children[ 4 ] = 5;
    waypoints[ 69 ] = spawnstruct();
    waypoints[ 69 ].origin = (148.173, 303.897, 16.125);
    waypoints[ 69 ].type = "stand";
    waypoints[ 69 ].children[ 0 ] = 2;
    waypoints[ 69 ].children[ 1 ] = 10;
    waypoints[ 69 ].children[ 2 ] = 68;
    waypoints[ 69 ].children[ 3 ] = 0;
    waypoints[ 69 ].children[ 4 ] = 1;
    waypoints[ 70 ] = spawnstruct();
    waypoints[ 70 ].origin = (556.377, 688.24, 16.125);
    waypoints[ 70 ].type = "stand";
    waypoints[ 70 ].children[ 0 ] = 66;
    waypoints[ 70 ].children[ 1 ] = 71;
    waypoints[ 70 ].children[ 2 ] = 13;
    waypoints[ 71 ] = spawnstruct();
    waypoints[ 71 ].origin = (687.562, 678.241, 16.125);
    waypoints[ 71 ].type = "stand";
    waypoints[ 71 ].children[ 0 ] = 70;
    waypoints[ 71 ].children[ 1 ] = 61;
    waypoints[ 71 ].children[ 2 ] = 9;
    waypoints[ 71 ].children[ 3 ] = 15;
    waypoints[ 71 ].children[ 4 ] = 66;
    waypoints[ 72 ] = spawnstruct();
    waypoints[ 72 ].origin = (848.518, 244.845, 16.125);
    waypoints[ 72 ].type = "stand";
    waypoints[ 72 ].children[ 0 ] = 15;
    waypoints[ 72 ].children[ 1 ] = 13;
    waypoints[ 72 ].children[ 2 ] = 41;
    waypoints[ 73 ] = spawnstruct();
    waypoints[ 73 ].origin = (386.577, 139.671, 16.125);
    waypoints[ 73 ].type = "stand";
    waypoints[ 73 ].children[ 0 ] = 44;
    waypoints[ 73 ].children[ 1 ] = 74;
    waypoints[ 74 ] = spawnstruct();
    waypoints[ 74 ].origin = (400.624, 18.1254, 16.125);
    waypoints[ 74 ].type = "stand";
    waypoints[ 74 ].children[ 0 ] = 73;
    waypoints[ 74 ].children[ 1 ] = 75;
    waypoints[ 75 ] = spawnstruct();
    waypoints[ 75 ].origin = (219.496, 18.1251, 16.125);
    ...
    waypoints[ 76 ].origin = (678.025, 887.34, 16.125);
    waypoints[ 76 ].type = "stand";
    waypoints[ 76 ].children[ 0 ] = 75;
    waypoints[ 76 ].children[ 1 ] = 63;
    waypoints[ 77 ] = spawnstruct();
    waypoints[ 77 ].origin = (1111.62, 667.391, 16.125);
    waypoints[ 77 ].type = "stand";
    waypoints[ 77 ].children[ 0 ] = 61;
    waypoints[ 77 ].children[ 1 ] = 17;
    waypoints[ 77 ].children[ 2 ] = 79;
    waypoints[ 77 ].children[ 3 ] = 80;
    waypoints[ 78 ] = spawnstruct();
    waypoints[ 78 ].origin = (1396.44, 788.231, 16.125);
    waypoints[ 78 ].type = "stand";
    waypoints[ 78 ].children[ 0 ] = 57;
    waypoints[ 78 ].children[ 1 ] = 79;
    waypoints[ 79 ] = spawnstruct();
    waypoints[ 79 ].origin = (1199.33, 775.324, 16.125);
    waypoints[ 79 ].type = "stand";
    waypoints[ 79 ].children[ 0 ] = 78;
    waypoints[ 79 ].children[ 1 ] = 60;
    waypoints[ 79 ].children[ 2 ] = 77;
    waypoints[ 80 ] = spawnstruct();
    waypoints[ 80 ].origin = (972.014, 627.64, 16.125);
    waypoints[ 80 ].type = "stand";
    waypoints[ 80 ].children[ 0 ] = 77;
    waypoints[ 80 ].children[ 1 ] = 15;
    waypoints[ 81 ] = spawnstruct();
    waypoints[ 81 ].origin = (1319.77, 358.525, 16.125);
    waypoints[ 81 ].type = "stand";
    waypoints[ 81 ].children[ 0 ] = 16;
    waypoints[ 81 ].children[ 1 ] = 82;
    waypoints[ 82 ] = spawnstruct();
    waypoints[ 82 ].origin = (1328.88, 144.444, 16.125);
    waypoints[ 82 ].type = "stand";
    waypoints[ 82 ].children[ 0 ] = 81;
    waypoints[ 82 ].children[ 1 ] = 37;
    waypoints[ 83 ] = spawnstruct();
    waypoints[ 83 ].origin = (1863.52, 675.426, 16.125);
    waypoints[ 83 ].type = "stand";
    waypoints[ 83 ].children[ 0 ] = 22;
    waypoints[ 83 ].children[ 1 ] = 84;
    waypoints[ 83 ].children[ 2 ] = 30;
    waypoints[ 83 ].children[ 3 ] = 26;
    waypoints[ 83 ].children[ 4 ] = 28;
    waypoints[ 83 ].children[ 5 ] = 27;
    waypoints[ 84 ] = spawnstruct();
    waypoints[ 84 ].origin = (1858.12, 322.473, 16.125);
    waypoints[ 84 ].type = "stand";
    waypoints[ 84 ].children[ 0 ] = 83;
    waypoints[ 84 ].children[ 1 ] = 20;
    waypoints[ 84 ].children[ 2 ] = 30;
    waypoints[ 84 ].children[ 3 ] = 29;
    waypoints[ 84 ].children[ 4 ] = 32;
    waypoints[ 85 ] = spawnstruct();
    waypoints[ 85 ].origin = (309.098, 693.845, 16.125);
    waypoints[ 85 ].type = "stand";
    waypoints[ 85 ].children[ 0 ] = 66;
    waypoints[ 85 ].children[ 1 ] = 8;
    return waypoints;
}
