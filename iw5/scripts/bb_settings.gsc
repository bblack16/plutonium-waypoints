...
setupGameModes() {
    // Set the domination scorelimit to 300.
    // Without this, the map vote migration results in the score going to 500.
    setDvar("scr_dom_scorelimit", 300);
    // Decrease Headquaters by 200
    setDvar("scr_koth_scorelimit", 300);
...
setupMapVote() {
    ...
    setDvar("csgo_var_2mapvote_maps", "^1[CSGO] ^7Assault,mp_csgo_assault:^1[CSGO] ^7Dust 2,mp_dust2:^1[CSGO] ^7Lake,mp_efa_lake:^1[CSGO] ^7Mirage,mp_csgo_mirage:^1[CSGO] ^7Mirage Night,mp_osg_mirage_n:^1[CSGO] ^7Office,mp_csgo_office:^1[CSGO] ^7Overpass,mp_overpass:^1[CSGO] ^7Safehouse,mp_safehouse:^1[CSGO] ^7Short Dust,mp_shortdust:^1[CSGO] ^7St. Marc,mp_csgo_stmarc");
